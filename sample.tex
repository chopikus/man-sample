...
\titleformat{\section}[display]{\filcenter}{\bfseries\thesection. }{0pt}{\bfseries\MakeUppercase} %Ставим название раздела по середине, делаем его КАПСЛОКОМ и переносим его на следующую строку (а также делаем жирным, спасибо @S1eap (#2))
